...
namespace Eco.Animation
{
    ...
    public static class AnimationStateManager
    {
        ...
        //Collect all trnsfered animation states in one place
        ...
        public static void InitAnimationStates()
        {
            ...
            AnimationStates[AvatarState.Swimming]         = new AvatarAnimationState(AvatarState.Swimming,         allowRotation: true,  useInAir: false, isSpecialState: true,  usedOnLadder: false, hideTool: true);
            ...
            AnimationStates[AvatarState.ClimbingLadder]   = new AvatarAnimationState(AvatarState.ClimbingLadder,   allowRotation: false, useInAir: false, isSpecialState: true,  usedOnLadder: true, hideTool: true);
